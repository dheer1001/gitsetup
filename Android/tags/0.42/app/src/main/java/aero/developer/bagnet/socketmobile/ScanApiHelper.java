...
// maintain a list of connected device (current only one scanner at a time)
     ...
     * kSktScanDataConfirmationModeApp
     */
    public void postBadScan(DeviceInfo deviceInfo, ICommandContextCallback callback) {
        ...
        newScanObj.getProperty().setUlong(
                SktScan.helper.SKTDATACONFIRMATION(
                        0,
                        values.dataConfirmation.kSktScanDataConfirmationRumbleBad,
                        values.dataConfirmation.kSktScanDataConfirmationBeepBad,
                        values.dataConfirmation.kSktScanDataConfirmationLedRed));
    ...
    public void postBadScanWithoutVibration(DeviceInfo deviceInfo, ICommandContextCallback callback) {
        ...
        newScanObj.getProperty().setUlong(
                SktScan.helper.SKTDATACONFIRMATION(
                        0,
                        values.dataConfirmation.kSktScanDataConfirmationLedNone,
                        values.dataConfirmation.kSktScanDataConfirmationBeepBad,
                        values.dataConfirmation.kSktScanDataConfirmationLedNone));
