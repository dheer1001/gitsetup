...
public class AutoresizeTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public AutoresizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AutoresizeTextView);
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 9, getResources().getDisplayMetrics());
