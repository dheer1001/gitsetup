package aero.developer.bagnet.manateeworks;
...
import static aero.developer.bagnet.manateeworks.CameraManager.screenX;
import static aero.developer.bagnet.manateeworks.CameraManager.screenY;
...
final class CameraConfigurationManager {
	...
	public static Point getCameraResolution(Parameters parameters, Point desiredResolution) {
		...
		screenX = sizes.get(minIndex).width;
		screenY = sizes.get(minIndex).height;
