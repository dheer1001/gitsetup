...
public class SelectAirlineFragment extends DialogFragment {
    ...
    private boolean openOnlyAirlineFragment = false;
    private OptionSelectionCallback optionSelectionCallback;

    public void setType(boolean openOnlyAirlineFragment, OptionSelectionCallback optionSelectionCallback) {
        this.openOnlyAirlineFragment = openOnlyAirlineFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        txt_select_airport.setText(getResources().getString(R.string.selectAirline));
        ...
        AirportAirlineAdapter adapter = new AirportAirlineAdapter(getContext(), AppController.getInstance().getAirportAirlineFromString(loginData.getAirlines())
                , getActivity(), false, openOnlyAirlineFragment, optionSelectionCallback);
    ...
    private void adjustColors() {
        ...
        ic_airport.setImageDrawable(getResources().getDrawable(R.drawable.icon_airplane));
