...
//===========================================New function added by issa ===================================================
//=========================================================================================================================


-(void)postSetDataConfirmationAtBackground:(DeviceInfo*)deviceInfo Target:(id)target Response:(SEL)response{
    ISktScanObject*scanObj=[SktClassFactory createScanObject];
    [[scanObj Property]setID:kSktScanPropIdDataConfirmationDevice];
    [[scanObj Property]setType:kSktScanPropTypeUlong];
    [[scanObj Property]setUlong:SKTDATACONFIRMATION(0, kSktScanDataConfirmationRumbleBad, kSktScanDataConfirmationBeepBad, kSktScanDataConfirmationLedRed)];
    CommandContext* command=[[CommandContext alloc]initWithParam:FALSE ScanObj:scanObj ScanDevice:[deviceInfo getSktScanDevice] Device:deviceInfo Target:target Response:response];
    [self addCommand:command];
#if __has_feature(objc_arc)
#else
    [command release];
...
-(void)postSetDataConfirmationError:(DeviceInfo*)deviceInfo Target:(id)target Response:(SEL)response{
    ISktScanObject*scanObj=[SktClassFactory createScanObject];
    [[scanObj Property]setID:kSktScanPropIdDataConfirmationDevice];
    [[scanObj Property]setType:kSktScanPropTypeUlong];
    [[scanObj Property]setUlong:SKTDATACONFIRMATION(0, kSktScanDataConfirmationRumbleNone,kSktScanDataConfirmationBeepBad,kSktScanDataConfirmationLedNone)];
    CommandContext* command=[[CommandContext alloc]initWithParam:FALSE ScanObj:scanObj ScanDevice:[deviceInfo getSktScanDevice] Device:deviceInfo Target:target Response:response];
    [self addCommand:command];
#if __has_feature(objc_arc)
#else
